 ...
 // var_dump(mysqli_query($conexion, $sql));
  ...
  while($row = mysqli_fetch_array($result)) {
    ...
    $json[] = array(
      ...
      'estado'=> $row['estado'],
      'botones'=>'<td>
            <button type="button" id="ver" class="btn btn-info  ver-item" id-item-ver="'.$row['id'].'  " title="Ver"><i 
            class="far fa-eye" data-coreui-toggle="modal" data-coreui-target="#modalVer"></i></button>
            <button type="button" id="edit" class="btn btn-warning  edit-item" id-item="'.$row['id'].'" title="Editar">
