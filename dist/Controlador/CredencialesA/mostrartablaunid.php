...
while ($row = mysqli_fetch_array($result)) {
    ...
    $json[] = array(
        ...
        'botones' => '<td>
            <button type="button" id="ver" class="btn btn-outline-info  verun-item" id-item-verun="'.$row['idpr'].'" title="Ver">
            <i class="far fa-eye" data-coreui-toggle="modal" data-coreui-target="#modalVerU"></i></button>
            <button type="button" id="edit" class="btn btn-outline-warning  editu-item" id-item-u="'.$row['idpr'].'" title="Editar">
