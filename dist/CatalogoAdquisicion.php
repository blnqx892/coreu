    ...
    <div class="body flex-grow-1 px-3">
      <div class="container-lg">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card mb-4">
              <div class="card-header"><strong>Actualización de Entradas</strong></div>
              <div class="card-body">
                        ...
                        <form>
                          <div class="row my-4">
                            <div class="col-md-4">
                              ...
                              <input type="date" class="form-control" id="fechae" disabled>
                            </div>
                            <div class="col-md-4">
                              <label for="inputZip" class="form-label">No. de Fatura:</label>
                ...
                <div class="modal fade" id="modale" tabindex="-1" aria-labelledby="exampleModalLabel"
                      ...
                      <div class="modal-body">
                        <form>
                          <div class="row my-4">
                            <div class="col-md-4">
                              <label for="inputZip" class="form-label">Fecha:</label>
                              <input type="date" class="form-control" id="fechaee">
                            </div>
                            <div class="col-md-4">
                              <label for="inputZip" class="form-label">No. de Fatura:</label>
                  ...
                  <input type="text" class="form-control" id="vidae">
                          ...
                          <div class="row my-4">
                            <div class="modal-footer">
                              <button class="btn btn-success" type="button" id="edite"
