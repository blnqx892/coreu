                      ...
                      ?>
                                    ...
                                    <div class="row  my-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control mi-validate-1" placeholder=""
                                                id="costoC" name="costoC">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <button type="button" title="Nuevo Proveedor" class="btn btn-primary"
                                                data-coreui-toggle="modal" data-coreui-target="#modalProv">
                                    ...
                                    <div class="row  my-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control mi-validate-1" id="nombreC"
                                                name="nombreC">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control mi-validate-1" id="marcaC"
                                                name="marcaC">
                                        </div>
                                    </div>
                                    <!--FIN SECCION TRES-->
                                    <div class="row  my-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control mi-validate-1" id="colorC"
                                                name="colorC">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label" for="validationCustom04">Tipo de Cargo: </label>
                                            <select class="form-select mi-validate-1" required="" id="cargoC"
                                                name="cargoC">
                                    ...
                                    <div class="row my-4">
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <button type="button" title="Nueva Categoria" class="btn btn-primary"
                                                    data-coreui-toggle="modal" data-coreui-target="#modalCate">
                                                    <i class='fas fa-plus'></i>
                                                </button>
                                            </div>
                                    </div>
                                    ...
                                    <div class="row  my-2">
                                            <div class="col-md-1">
                                                <label class="form-check-label"
                                                    for="flexSwitchCheckChecked">Transporte</label>
                                    ...
                                    <div id="formulario" style="display:none;">
                                        ...
                                        <div class="row my-1">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="number" class="form-control" id="capacidadC"
                                                        name="capacidadC">
                                                </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-15" align="right">
                                            <hr style="color: black; background-color: black; width:100%;" />
                                            <button class="btn btn-success" type="submit" id="GuardaEntradas"
                                                name="btnGuardar">Guardar <i class='far fa-check-square'></i>
                                            </button>
