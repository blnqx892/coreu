                ...
                <div class="card-body">
                  ...
                  <form class="g-3 needs-validation" action="Controlador/IngresoSuministrosC.php" method="POST"
                    ...
                    <div class="col-15" align="right">
                      ...
                      <button class="btn btn-success " type="button" id="save_record">Guardar <i
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row my-4">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="number" min="1.00" step="0.01" class="form-control v-required-2 v-min-2"
                          id="cantidad" name="nombreProv" data-min="1.00">
                      </div>
                      <div class="col-md-3">
                        <label for="inputCity" class="form-label">Precio:</label>
                        <input type="number" min="0.00" step="0.01" class="form-control v-required-2 v-min-2"
                          id="precio" name="nombreProv" data-min="0.00">
                      </div>
                    </div>
                  </div>
