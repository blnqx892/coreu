        ...
        <div class="row">
          <div class="col-12">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <!--------------------------INICIO FORM--------------------------------------------------->
                <form id="formM" class="g-3 needs-validation" action="AsignaciondeActivo.php" method="POST"
                  autocomplete="off">
                  ...
                  <div class="col-15" align="right">
                    <hr style="color: black; background-color: black; width:100%;" />
                    <button class="btn btn-success" type="button" id="GuardaMovimientos" name="btnGuardar">Guardar <i
